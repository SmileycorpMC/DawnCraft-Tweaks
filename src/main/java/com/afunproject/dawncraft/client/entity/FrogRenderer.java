...
public class FrogRenderer extends LivingEntityRenderer<LivingEntity, FrogModel> {
	...
	public static ModelLayerLocation DEFAULT = new ModelLayerLocation(new ResourceLocation(ModDefinitions.MODID, "frog"), "default");
	...
	public ResourceLocation getTextureLocation(LivingEntity entity) {
		return ModDefinitions.getResource("textures/entity/frog.png");
	}
