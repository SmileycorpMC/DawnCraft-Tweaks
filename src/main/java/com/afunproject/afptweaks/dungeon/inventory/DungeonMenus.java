package com.afunproject.afptweaks.dungeon.inventory;
...
public class DungeonMenus {
	...
	public static DeferredRegister<MenuType<?>> MENU_TYPES = DeferredRegister.create(ForgeRegistries.CONTAINERS, ModDefinitions.MODID);
